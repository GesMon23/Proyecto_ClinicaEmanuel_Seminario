...
const EgresoReporte = () => {
    ...
    const exportarExcel = () => {
        ...
        window.open(`http://localhost:3001/api/reportes/egreso/excel?${params.toString()}`);
    };
                 ...
                 <div className="overflow-x-auto">
                    ...
                    <thead className="bg-gray-100 dark:bg-slate-800 text-xs uppercase font-semibold text-gray-700 dark:text-gray-200">
                            <tr>
                                ...
                                <th className="min-w-[200px] px-4 py-2">Causa de egreso</th>
                                <th className="min-w-[140px] px-4 py-2">Fecha de Egreso</th>
                                <th className="min-w-[180px] px-4 py-2">No. Oficio Caso Concluido</th>
                            ...
                            {loading ? (
                                ...
                                pacientesPaginados.map((paciente, idx) => (
                                    <tr key={paciente.id || idx}>
                                        ...
                                        <td className="px-4 py-2">{paciente.causaegreso_descripcion || paciente.causaegreso || ''}</td>
                                        <td className="px-4 py-2">{paciente.fechaegreso || ''}</td>
                                        <td className="px-4 py-2">{paciente.nocasoconcluido || ''}</td>

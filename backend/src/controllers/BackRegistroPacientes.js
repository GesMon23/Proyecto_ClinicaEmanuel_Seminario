...
const RegistroPacientes = () => {
  ...
  // descarga el PDF a disco con el nombre {noAf}_carnet.pdf
  const descargarCarnetDesdeRespuesta = async (noAf, carnetUrlFromBackend) => {
    try {
      if (carnetUrlFromBackend) {
        // Intento directo usando la URL del backend (relativa)
        const r1 = await api.get(carnetUrlFromBackend, { responseType: "blob" });
        const blob = new Blob([r1.data], { type: "application/pdf" });
        const url = window.URL.createObjectURL(blob);
        const a = document.createElement("a");
        a.href = url;
        a.download = `${String(noAf).trim()}_carnet.pdf`;
      ...
      // si falla, cae al retry contra /carnet/forzar
    }

    // Respaldo con reintentos
    const carnetRes = await fetchCarnetWithRetry(String(noAf).trim(), 3);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const pacienteData = {
        noafiliacion: String(formData.noAfiliacion).trim(),
        dpi: dpiTrim,
        ...
        apellidocasada: formData.sexo === "Femenino" ? formData.apellidoCasada?.trim() || null : null,
      ...
      const postRes = await api.post("/pacientes", pacienteData);

      // 2) Descargar carné — usa carnetUrl si viene; si no, usa retry
      const noAf = postRes?.data?.no_afiliacion ?? String(formData.noAfiliacion).trim();
      const carnetUrl = postRes?.data?.carnetUrl;
      await descargarCarnetDesdeRespuesta(noAf, carnetUrl);
              ...
              <form onSubmit={handleSubmit}>
                <div className="mb-6 w-full text-center">
                  <div className="flex flex-wrap items-center justify-center gap-6">
                    ...
                    />
                    <h2 className="mb-4 text-3xl font-bold text-green-800 dark:text-white">Registro de Pacientes</h2>
                  </div>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  <div>
                    <label htmlFor="noAfiliacion" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      No. Afiliación *
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="dpi" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      DPI *
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="primerNombre" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      Primer Nombre *
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="segundoNombre" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      Segundo Nombre
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="otrosNombres" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      Otros Nombres
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="primerApellido" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      Primer Apellido *
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="segundoApellido" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      Segundo Apellido
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="apellidoCasada" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      Apellido Casada
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="fechaNacimiento" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      Fecha de Nacimiento
                    </label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label htmlFor="sexo" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      Género *
                    </label>
                    <select
                      id="sexo"
                  ...
                  <div className="md:col-span-2">
                    <label htmlFor="direccion" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      Dirección *
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label htmlFor="fechaIngreso" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      Fecha de Ingreso *
                    </label>
                    <input
                      type="date"
                  ...
                  <div>
                    <label htmlFor="idDepartamento" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      Departamento *
                    </label>
                    <select
                      id="idDepartamento"
                  ...
                  <div>
                    <label htmlFor="idAcceso" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      Acceso Vascular *
                    </label>
                    <select
                      id="idAcceso"
                  ...
                  <div>
                    <label htmlFor="numeroFormulario" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                  ...
                  <div>
                    <label htmlFor="idjornada" className="mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">
                      Jornada *
                    </label>
                    <select
                      id="idjornada"
